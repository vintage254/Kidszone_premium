          ...
          {product.filters && product.filters.length > 0 && (
            <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-medium text-blue-900 mb-1">Multiple Variants Available</h4>
                  <p className="text-sm text-blue-800">
                    You can add the same product with different options to your cart. For example, select "age 2" and add to cart, then select "age 3" and add again to have both variants in your cart.
                  </p>
                </div>
              </div>
            </div>
